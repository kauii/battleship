...
public class FleetTest {
	...
	@Test
	void checkIDTest() {
		assertEquals(fleet.checkId("C1").getClass(),Boat.class);
		assertEquals(fleet.checkId("B1").getClass(),Boat.class);
		assertEquals(fleet.checkId("S3").getClass(),Boat.class);
		assertEquals(fleet.checkId("P3").getClass(),Boat.class);
	}
